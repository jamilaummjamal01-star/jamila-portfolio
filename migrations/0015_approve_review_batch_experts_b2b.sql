...
-- Owner-approved review batch 5 of 5: experts and B2B companies.
...
SELECT
  'audit-review-batch-5-' || ki.id,
  'jamila.shakurova@gmail.com',
  'approve',
  'knowledge_item',
  ki.id,
  json_object('title', ki.title, 'status', 'review', 'version', 2),
  json_object('title', ki.title, 'status', 'approved', 'version', 3, 'source', 'owner-approved-review-batch-5'),
  CURRENT_TIMESTAMP
